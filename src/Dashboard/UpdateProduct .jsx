    ...
    const fetchData = async () => {
      try {
        ...
        if (docSnap.exists()) {
          ...
          setName(docSnap.data().tensp)
          setPrice(docSnap.data().gia)
          setThuonghieu(docSnap.data().thuonghieu)
          setMota(docSnap.data().motasp)
          setDanhmuc(docSnap.data().danhmuc)
          setImg(docSnap.data().anhsp)
        } else {
