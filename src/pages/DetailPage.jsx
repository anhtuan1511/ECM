...
export default function DetailPage() {
  return (
    <div>
    <div className="grid grid-cols-2 gap-[40px] mt-[96px] ">
    ...
    <p className="max-w-[1002px] mx-auto mt-[61px]">The LG C2 42 (106cm) 4K Smart OLED evo TV is the best all-around OLED TV we've tested. Although all OLEDs deliver similar fantastic picture quality, this one stands out for its value because it has many gaming-oriented features that are great for gamers.
